...
<div id="rds" class="settings">
    <fieldset>
        ...
        <p>
            Before you use the RDS capabilities of your EDM FM transmitter you must be comfortable
            with soldering and connect the SCL and SDA pins from the RDS chip located within the EDM FM transmitter
            to two pins on the raspberry Pi. Currently the two PINs to use are pin 23 and 24 for SCL and SDA
            respectively.
            <br><br><br>
            Configuration of the RDS settings for the EDM transmitter can be found here:
        ...
        <p>
            When you create your MP3 and OGG files, make sure you tag them with Artist and Title fields. You can upload
            the MP3s and OGG files through the
            File Manager in the Content Setup menu. Once the tags are set, this plug in will automatically update the
            RDS text when the file is played!
        </p>
        <p>
            Known Issues:
            <ul>
            ...
            <form method="post" action="/plugin.php?plugin=fpp-edmrds&page=output.php">
            ...
            <p>To report a bug, please file it against the fpp-vastfmt plugin project here:
                <a href="https://github.com/drlucas/fpp-edmrds/issues/new" target="_new">fpp-edmrds GitHub Issues</a>
            </p>
